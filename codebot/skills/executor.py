...
from codebot.skills.parser import SkillDef, substitute_arguments
from codebot.tools import ToolRegistry

if TYPE_CHECKING:
    from codebot.agent import Agent, AgentEvent
...
class SkillExecutor:
    ...
    async def execute_fork(
        ...
        from codebot.agent import Agent as AgentClass, StreamText, LoopComplete, ErrorEvent
