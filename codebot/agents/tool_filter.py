...
def build_teammate_tools(
    ...
    from codebot.tools.send_message import SendMessageTool
    from codebot.tools.task_create import TaskCreateTool
    from codebot.tools.task_get import TaskGetTool
    from codebot.tools.task_list import TaskListTool
    from codebot.tools.task_update import TaskUpdateTool
