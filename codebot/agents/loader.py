...
PROJECT_AGENTS_DIR = ".codebot/agents"
USER_AGENTS_DIR = "~/.codebot/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("codebot.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from codebot.agents.parser import parse_frontmatter, _validate_agent_meta
