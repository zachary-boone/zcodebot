...
from codebot.commands import (
    CommandContext,
    CommandRegistry,
    complete,
    parse_command,
)
from codebot.commands.completion import CompletionPopup
from codebot.commands.handlers import register_all_commands
from codebot.config import MCPServerConfig, ProviderConfig
from codebot.hooks import HookContext, HookEngine, load_hooks
from codebot.conversation import ConversationManager, Message
from codebot.mcp import MCPManager
from codebot.memory import (
    MemoryManager,
    Session,
    SessionManager,
...
from codebot.commands.handlers.tasks import create_tasks_command
from codebot.skills.executor import SkillExecutor
from codebot.skills.loader import SkillLoader
from codebot.commands.handlers.skill_register import register_skill_commands
...
from codebot.tools.ask_user import AskUserEvent, AskUserTool
from codebot.tools.impl.tool_search import ToolSearchTool
from codebot.tools.load_skill import LoadSkill
from codebot.worktree.cleanup import start_stale_cleanup_task
from codebot.worktree.manager import WorktreeManager
from codebot.commands.handlers.worktree import create_worktree_command
from codebot.teammate_tree import TeammateTree
...
_SKIP_DIRS = {".git", "node_modules", ".venv", "__pycache__", ".codebot", "build", ".gradle"}
...
class ChatInput(TextArea):
    ...
    def load_history(self, work_dir: str) -> None:
        self._history_file = Path(work_dir) / ".codebot" / "history"
...
class CodeBotApp(App):
    ...
    def on_mount(self) -> None:
        self.register_theme(_CODEBOT_THEME)
        self.theme = "codebot"
        if len(self.providers) == 1:
    ...
    def _select_provider(self, provider: ProviderConfig) -> None:
        ...
        from codebot.filehistory import FileHistory
        ...
        from codebot.tools.enter_worktree import EnterWorktreeTool
        from codebot.tools.exit_worktree import ExitWorktreeTool
        ...
        from codebot.commands.handlers.trace import create_trace_command
        ...
        from codebot.tools.synthetic_output import SyntheticOutputTool
    ...
    async def _show_plan_approval(self) -> None:
        from codebot.plan_dialog import InlinePlanWidget
    ...
    def on_inline_plan_widget_responded(
        ...
        from codebot.plan_dialog import InlinePlanWidget, PlanChoice
    ...
    async def _handle_askuser(self, event: AskUserEvent) -> None:
        from codebot.askuser_dialog import InlineAskUserWidget
    ...
    async def _handle_permission_request(self, request: PermissionRequest) -> None:
        from codebot.permission_dialog import InlinePermissionWidget
