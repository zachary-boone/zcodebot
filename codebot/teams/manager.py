...
from codebot.teams.mailbox import Mailbox, create_message
...
from codebot.teams.progress import TeammateProgress
from codebot.teams.registry import AgentNameRegistry
from codebot.teams.shared_task import SharedTaskStore
from codebot.teams.spawn_inprocess import InProcessTeammateHandle
    ...
    def _kill_pane(self, pane_id: str, backend_type: str) -> None:
        try:
            if backend_type == BackendType.TMUX.value:
                from codebot.teams.spawn_tmux import kill_pane
                kill_pane(pane_id)
